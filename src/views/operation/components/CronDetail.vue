    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label-width="120px" label="Script Name:" prop="code_id" class="postInfo-container-item">
                    <el-select v-model="postForm.code_id" class="filter-item" placeholder="Please select" filterable @change="getCodeContent">
        ...
        <el-form-item style="margin-bottom: 30px;">
          <python-editor ref="editor" :readonly="true" :height="pythonEditorHigh" :width="'100%'" />
        </el-form-item>
...
export default {
  ...
  created() {
    this.pythonEditorHigh = window.innerHeight - 360 + 'px'
    if (this.isEdit) {
